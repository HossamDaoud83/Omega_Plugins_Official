---
description: Audit property against brand standards; identify gaps and remediation cost.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-hospitality:brand-audit

**Brand Standards Audit.** Audit property against brand standards; identify gaps and remediation cost.

## When to use

When the engagement scope explicitly calls for brand standards audit work in the hospitality domain. Look for keywords like: hospitality, hotel, resort, RevPAR, ADR.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `hospitality-brand-audit-<client>-<YYYYMMDD>.md`.
