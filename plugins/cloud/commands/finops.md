---
description: Stand up FinOps practice: showback, rightsizing, commitments, anomaly detection.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-cloud:finops

**FinOps Setup.** Stand up FinOps practice: showback, rightsizing, commitments, anomaly detection.

## When to use

When the engagement scope explicitly calls for finops setup work in the cloud strategy & finops domain. Look for keywords like: cloud, AWS, Azure, GCP, FinOps.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `cloud-finops-<client>-<YYYYMMDD>.md`.
