---
description: Define cloud operating model, target architecture, and 18-month roadmap.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-cloud:cloud-strategy

**Cloud Strategy.** Define cloud operating model, target architecture, and 18-month roadmap.

## When to use

When the engagement scope explicitly calls for cloud strategy work in the cloud strategy & finops domain. Look for keywords like: cloud, AWS, Azure, GCP, FinOps.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `cloud-cloud-strategy-<client>-<YYYYMMDD>.md`.
