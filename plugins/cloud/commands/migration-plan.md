---
description: Develop application migration plan using 6Rs; produce wave plan.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-cloud:migration-plan

**Migration Plan.** Develop application migration plan using 6Rs; produce wave plan.

## When to use

When the engagement scope explicitly calls for migration plan work in the cloud strategy & finops domain. Look for keywords like: cloud, AWS, Azure, GCP, FinOps.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `cloud-migration-plan-<client>-<YYYYMMDD>.md`.
