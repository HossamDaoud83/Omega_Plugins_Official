---
description: Design irrigation strategy balancing water cost, crop yield, sustainability.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-agritech:irrigation-design

**Irrigation Strategy.** Design irrigation strategy balancing water cost, crop yield, sustainability.

## When to use

When the engagement scope explicitly calls for irrigation strategy work in the agriculture & agritech domain. Look for keywords like: agriculture, agritech, crop, irrigation, food.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `agritech-irrigation-design-<client>-<YYYYMMDD>.md`.
