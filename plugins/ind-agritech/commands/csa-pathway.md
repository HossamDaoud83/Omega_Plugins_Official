---
description: Develop climate-smart agriculture pathway (mitigation + adaptation + productivity).
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-agritech:csa-pathway

**Climate-Smart Pathway.** Develop climate-smart agriculture pathway (mitigation + adaptation + productivity).

## When to use

When the engagement scope explicitly calls for climate-smart pathway work in the agriculture & agritech domain. Look for keywords like: agriculture, agritech, crop, irrigation, food.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `agritech-csa-pathway-<client>-<YYYYMMDD>.md`.
