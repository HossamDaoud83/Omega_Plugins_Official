---
description: Cluster interview transcripts into candidate personas using thematic analysis.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-aipersonas:cluster

**Interview Clustering.** Cluster interview transcripts into candidate personas using thematic analysis.

## When to use

When the engagement scope explicitly calls for interview clustering work in the ai persona synthesis domain. Look for keywords like: persona, journey, interview, focus group, JTBD.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `aipersonas-cluster-<client>-<YYYYMMDD>.md`.
