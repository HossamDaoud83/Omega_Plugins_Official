---
description: Build canonical persona cards with name, role, JTBD, pain points, evidence-anchored quotes.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-aipersonas:persona-build

**Persona Build.** Build canonical persona cards with name, role, JTBD, pain points, evidence-anchored quotes.

## When to use

When the engagement scope explicitly calls for persona build work in the ai persona synthesis domain. Look for keywords like: persona, journey, interview, focus group, JTBD.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `aipersonas-persona-build-<client>-<YYYYMMDD>.md`.
