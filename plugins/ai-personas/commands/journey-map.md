---
description: Map a persona's journey across touchpoints with quotes per moment.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-aipersonas:journey-map

**Persona Journey Map.** Map a persona's journey across touchpoints with quotes per moment.

## When to use

When the engagement scope explicitly calls for persona journey map work in the ai persona synthesis domain. Look for keywords like: persona, journey, interview, focus group, JTBD.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `aipersonas-journey-map-<client>-<YYYYMMDD>.md`.
