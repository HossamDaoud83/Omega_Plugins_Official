---
description: Review LoM plan: pit design, grade control, sequencing.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-mining:mine-plan

**Mine Plan Review.** Review LoM plan: pit design, grade control, sequencing.

## When to use

When the engagement scope explicitly calls for mine plan review work in the mining & metals domain. Look for keywords like: mining, metals, ore, JORC, NI 43-101.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `mining-mine-plan-<client>-<YYYYMMDD>.md`.
