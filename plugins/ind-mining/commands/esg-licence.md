---
description: Diagnose social license risks; recommend community engagement program.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-mining:esg-licence

**ESG License to Operate.** Diagnose social license risks; recommend community engagement program.

## When to use

When the engagement scope explicitly calls for esg license to operate work in the mining & metals domain. Look for keywords like: mining, metals, ore, JORC, NI 43-101.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `mining-esg-licence-<client>-<YYYYMMDD>.md`.
