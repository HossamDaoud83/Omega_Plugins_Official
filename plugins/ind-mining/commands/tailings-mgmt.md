---
description: Assess tailings management vs Global Industry Standard on Tailings Management.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-mining:tailings-mgmt

**Tailings Management.** Assess tailings management vs Global Industry Standard on Tailings Management.

## When to use

When the engagement scope explicitly calls for tailings management work in the mining & metals domain. Look for keywords like: mining, metals, ore, JORC, NI 43-101.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `mining-tailings-mgmt-<client>-<YYYYMMDD>.md`.
