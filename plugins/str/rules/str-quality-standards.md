# Corporate Business Advisory (STR) — Quality Standards

Omega service-line specific quality criteria for `@omega/str` deliverables. Loaded automatically when this plugin is installed.
...
See the `str` skill SKILL.md "Quality checklist" section for methodology-specific criteria. Examples drawn from the v3 quality table:

- Market sizing validated (TAM/SAM/SOM, sources)
- Competitive data sourced
- Strategic options MECE
- Financial models pass three-statement integrity checks
