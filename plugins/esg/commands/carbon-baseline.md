---
description: Establish Scope 1/2/3 inventory using GHG Protocol; produce baseline year report.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-esg:carbon-baseline

**Carbon Baseline.** Establish Scope 1/2/3 inventory using GHG Protocol; produce baseline year report.

## When to use

When the engagement scope explicitly calls for carbon baseline work in the esg & sustainability domain. Look for keywords like: ESG, sustainability, carbon accounting, Scope 1/2/3, GHG Protocol.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `esg-carbon-baseline-<client>-<YYYYMMDD>.md`.
