---
description: Run double-materiality assessment per CSRD ESRS 1; identify material topics.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-esg:materiality

**Materiality Assessment.** Run double-materiality assessment per CSRD ESRS 1; identify material topics.

## When to use

When the engagement scope explicitly calls for materiality assessment work in the esg & sustainability domain. Look for keywords like: ESG, sustainability, carbon accounting, Scope 1/2/3, GHG Protocol.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `esg-materiality-<client>-<YYYYMMDD>.md`.
