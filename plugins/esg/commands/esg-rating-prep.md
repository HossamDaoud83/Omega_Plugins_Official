---
description: Prepare for MSCI/Sustainalytics/CDP scoring; identify quick wins.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-esg:esg-rating-prep

**ESG Rating Prep.** Prepare for MSCI/Sustainalytics/CDP scoring; identify quick wins.

## When to use

When the engagement scope explicitly calls for esg rating prep work in the esg & sustainability domain. Look for keywords like: ESG, sustainability, carbon accounting, Scope 1/2/3, GHG Protocol.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `esg-esg-rating-prep-<client>-<YYYYMMDD>.md`.
