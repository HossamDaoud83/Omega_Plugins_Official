---
description: Re-engineer a target process for cycle time, quality, and cost gains.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ops:process-redesign

**Process Redesign.** Re-engineer a target process for cycle time, quality, and cost gains.

## When to use

When the engagement scope explicitly calls for process redesign work in the operational excellence domain. Look for keywords like: lean, six sigma, VSM, kaizen, DMAIC.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `ops-process-redesign-<client>-<YYYYMMDD>.md`.
