---
description: Score the operation against Shingo Model dimensions.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ops:lean-assess

**Lean Maturity Assessment.** Score the operation against Shingo Model dimensions.

## When to use

When the engagement scope explicitly calls for lean maturity assessment work in the operational excellence domain. Look for keywords like: lean, six sigma, VSM, kaizen, DMAIC.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `ops-lean-assess-<client>-<YYYYMMDD>.md`.
