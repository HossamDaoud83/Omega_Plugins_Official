---
description: Plan and facilitate a 3-5 day kaizen / improvement event.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ops:kaizen-event

**Kaizen Event Plan.** Plan and facilitate a 3-5 day kaizen / improvement event.

## When to use

When the engagement scope explicitly calls for kaizen event plan work in the operational excellence domain. Look for keywords like: lean, six sigma, VSM, kaizen, DMAIC.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `ops-kaizen-event-<client>-<YYYYMMDD>.md`.
