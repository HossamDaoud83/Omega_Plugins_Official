---
description: Define filing strategy across FDA / EMA / GCC including pathway selection.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-pharma:regulatory-strategy

**Regulatory Strategy.** Define filing strategy across FDA / EMA / GCC including pathway selection.

## When to use

When the engagement scope explicitly calls for regulatory strategy work in the pharma & life sciences domain. Look for keywords like: pharma, life sciences, GxP, GMP, GCP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `pharma-regulatory-strategy-<client>-<YYYYMMDD>.md`.
