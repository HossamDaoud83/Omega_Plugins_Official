---
description: Assess GxP (GMP/GLP/GCP/GDP) readiness; identify control gaps.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-pharma:gxp-readiness

**GxP Readiness.** Assess GxP (GMP/GLP/GCP/GDP) readiness; identify control gaps.

## When to use

When the engagement scope explicitly calls for gxp readiness work in the pharma & life sciences domain. Look for keywords like: pharma, life sciences, GxP, GMP, GCP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `pharma-gxp-readiness-<client>-<YYYYMMDD>.md`.
