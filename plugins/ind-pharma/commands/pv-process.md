---
description: Assess PV process including ICSR handling, signal detection, PSUR/PBRER.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-pharma:pv-process

**Pharmacovigilance Process.** Assess PV process including ICSR handling, signal detection, PSUR/PBRER.

## When to use

When the engagement scope explicitly calls for pharmacovigilance process work in the pharma & life sciences domain. Look for keywords like: pharma, life sciences, GxP, GMP, GCP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `pharma-pv-process-<client>-<YYYYMMDD>.md`.
