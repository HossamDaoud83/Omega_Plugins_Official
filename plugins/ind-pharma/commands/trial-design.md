---
description: Review clinical trial protocol design and statistical approach.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-pharma:trial-design

**Clinical Trial Design Review.** Review clinical trial protocol design and statistical approach.

## When to use

When the engagement scope explicitly calls for clinical trial design review work in the pharma & life sciences domain. Look for keywords like: pharma, life sciences, GxP, GMP, GCP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `pharma-trial-design-<client>-<YYYYMMDD>.md`.
