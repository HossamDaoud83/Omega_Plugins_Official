---
description: Build quality-of-earnings baseline from financials with normalization adjustments.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-aidd:qoe-baseline

**QoE Baseline.** Build quality-of-earnings baseline from financials with normalization adjustments.

## When to use

When the engagement scope explicitly calls for qoe baseline work in the ai-assisted due diligence domain. Look for keywords like: due diligence, DD, data room, red flag, QoE.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `aidd-qoe-baseline-<client>-<YYYYMMDD>.md`.
