---
description: Export client-facing version with PII / sensitive details redacted.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-aidd:redaction-export

**Redacted Export.** Export client-facing version with PII / sensitive details redacted.

## When to use

When the engagement scope explicitly calls for redacted export work in the ai-assisted due diligence domain. Look for keywords like: due diligence, DD, data room, red flag, QoE.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `aidd-redaction-export-<client>-<YYYYMMDD>.md`.
