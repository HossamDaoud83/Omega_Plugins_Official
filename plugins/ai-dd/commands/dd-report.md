---
description: Author DD report with findings, severity, recommended price/structure adjustments.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-aidd:dd-report

**DD Report.** Author DD report with findings, severity, recommended price/structure adjustments.

## When to use

When the engagement scope explicitly calls for dd report work in the ai-assisted due diligence domain. Look for keywords like: due diligence, DD, data room, red flag, QoE.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `aidd-dd-report-<client>-<YYYYMMDD>.md`.
