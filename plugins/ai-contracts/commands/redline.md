---
description: Propose redlines to bring deviations into playbook compliance.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-aicontracts:redline

**Redline Suggestions.** Propose redlines to bring deviations into playbook compliance.

## When to use

When the engagement scope explicitly calls for redline suggestions work in the ai contract review domain. Look for keywords like: contract, clause, indemnity, limitation of liability, IP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `aicontracts-redline-<client>-<YYYYMMDD>.md`.
