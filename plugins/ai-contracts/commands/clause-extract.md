---
description: Extract named clauses (indemnity, limitation of liability, IP, termination, etc.) with confidence scores.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-aicontracts:clause-extract

**Clause Extraction.** Extract named clauses (indemnity, limitation of liability, IP, termination, etc.) with confidence scores.

## When to use

When the engagement scope explicitly calls for clause extraction work in the ai contract review domain. Look for keywords like: contract, clause, indemnity, limitation of liability, IP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `aicontracts-clause-extract-<client>-<YYYYMMDD>.md`.
