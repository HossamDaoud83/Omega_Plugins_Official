---
description: Compare two contracts clause-by-clause; produce delta report.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-aicontracts:compare

**Contract Comparison.** Compare two contracts clause-by-clause; produce delta report.

## When to use

When the engagement scope explicitly calls for contract comparison work in the ai contract review domain. Look for keywords like: contract, clause, indemnity, limitation of liability, IP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `aicontracts-compare-<client>-<YYYYMMDD>.md`.
