---
description: Author / refresh incident response runbooks with severity tiers and playbooks.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-cyber:incident-runbook

**Incident Runbook.** Author / refresh incident response runbooks with severity tiers and playbooks.

## When to use

When the engagement scope explicitly calls for incident runbook work in the cybersecurity domain. Look for keywords like: cybersecurity, ISO 27001, NIST CSF, threat modeling, STRIDE.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `cyber-incident-runbook-<client>-<YYYYMMDD>.md`.
