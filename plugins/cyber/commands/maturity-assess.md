---
description: Score the client's security capabilities against NIST CSF / ISO 27001 controls.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-cyber:maturity-assess

**Maturity Assessment.** Score the client's security capabilities against NIST CSF / ISO 27001 controls.

## When to use

When the engagement scope explicitly calls for maturity assessment work in the cybersecurity domain. Look for keywords like: cybersecurity, ISO 27001, NIST CSF, threat modeling, STRIDE.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `cyber-maturity-assess-<client>-<YYYYMMDD>.md`.
