---
description: Score third-party vendors on security posture using CAIQ / SIG Lite.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-cyber:vendor-risk

**Vendor Risk Assessment.** Score third-party vendors on security posture using CAIQ / SIG Lite.

## When to use

When the engagement scope explicitly calls for vendor risk assessment work in the cybersecurity domain. Look for keywords like: cybersecurity, ISO 27001, NIST CSF, threat modeling, STRIDE.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `cyber-vendor-risk-<client>-<YYYYMMDD>.md`.
