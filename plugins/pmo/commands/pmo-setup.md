---
description: Stand up a PMO: charter, operating model, governance, tools.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-pmo:pmo-setup

**PMO Setup.** Stand up a PMO: charter, operating model, governance, tools.

## When to use

When the engagement scope explicitly calls for pmo setup work in the pmo & program delivery domain. Look for keywords like: PMO, portfolio, program, project, RAID.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `pmo-pmo-setup-<client>-<YYYYMMDD>.md`.
