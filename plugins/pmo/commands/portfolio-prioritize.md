---
description: Score and rank initiatives using strategic-fit, value, and feasibility lenses.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-pmo:portfolio-prioritize

**Portfolio Prioritization.** Score and rank initiatives using strategic-fit, value, and feasibility lenses.

## When to use

When the engagement scope explicitly calls for portfolio prioritization work in the pmo & program delivery domain. Look for keywords like: PMO, portfolio, program, project, RAID.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `pmo-portfolio-prioritize-<client>-<YYYYMMDD>.md`.
