---
description: Author program charter: scope, objectives, governance, RAID, success criteria.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-pmo:program-charter

**Program Charter.** Author program charter: scope, objectives, governance, RAID, success criteria.

## When to use

When the engagement scope explicitly calls for program charter work in the pmo & program delivery domain. Look for keywords like: PMO, portfolio, program, project, RAID.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `pmo-program-charter-<client>-<YYYYMMDD>.md`.
