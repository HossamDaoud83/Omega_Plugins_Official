---
description: Audit RAID log for stale items; drive resolution and aging-out.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-pmo:raid-cleanup

**RAID Cleanup.** Audit RAID log for stale items; drive resolution and aging-out.

## When to use

When the engagement scope explicitly calls for raid cleanup work in the pmo & program delivery domain. Look for keywords like: PMO, portfolio, program, project, RAID.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `pmo-raid-cleanup-<client>-<YYYYMMDD>.md`.
