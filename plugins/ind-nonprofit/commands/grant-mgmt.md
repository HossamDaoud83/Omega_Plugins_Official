---
description: Set up grant management system: pipeline, compliance, reporting.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-nonprofit:grant-mgmt

**Grant Management.** Set up grant management system: pipeline, compliance, reporting.

## When to use

When the engagement scope explicitly calls for grant management work in the nonprofit & ngo domain. Look for keywords like: nonprofit, NGO, theory of change, grant, donor.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `nonprofit-grant-mgmt-<client>-<YYYYMMDD>.md`.
