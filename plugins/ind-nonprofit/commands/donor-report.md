---
description: Author donor report with results vs commitment, qualitative case stories.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-nonprofit:donor-report

**Donor Reporting.** Author donor report with results vs commitment, qualitative case stories.

## When to use

When the engagement scope explicitly calls for donor reporting work in the nonprofit & ngo domain. Look for keywords like: nonprofit, NGO, theory of change, grant, donor.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `nonprofit-donor-report-<client>-<YYYYMMDD>.md`.
