---
description: Map risks to controls; identify orphan risks and over-controlled areas.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-risk:control-map

**Control Mapping.** Map risks to controls; identify orphan risks and over-controlled areas.

## When to use

When the engagement scope explicitly calls for control mapping work in the enterprise risk management domain. Look for keywords like: risk, ERM, COSO, ISO 31000, risk appetite.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `risk-control-map-<client>-<YYYYMMDD>.md`.
