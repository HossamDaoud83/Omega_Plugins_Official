---
description: Develop business continuity and disaster recovery plans with RTO/RPO targets.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-risk:bcp-dr

**BCP / DR Plan.** Develop business continuity and disaster recovery plans with RTO/RPO targets.

## When to use

When the engagement scope explicitly calls for bcp / dr plan work in the enterprise risk management domain. Look for keywords like: risk, ERM, COSO, ISO 31000, risk appetite.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `risk-bcp-dr-<client>-<YYYYMMDD>.md`.
