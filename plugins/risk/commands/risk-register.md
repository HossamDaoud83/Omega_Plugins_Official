---
description: Build / refresh enterprise risk register with risk owners, residual scoring.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-risk:risk-register

**Risk Register Build.** Build / refresh enterprise risk register with risk owners, residual scoring.

## When to use

When the engagement scope explicitly calls for risk register build work in the enterprise risk management domain. Look for keywords like: risk, ERM, COSO, ISO 31000, risk appetite.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `risk-risk-register-<client>-<YYYYMMDD>.md`.
