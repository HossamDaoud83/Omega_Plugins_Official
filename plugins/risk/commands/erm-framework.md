---
description: Design or refresh enterprise risk framework aligned to COSO ERM 2017 / ISO 31000.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-risk:erm-framework

**ERM Framework.** Design or refresh enterprise risk framework aligned to COSO ERM 2017 / ISO 31000.

## When to use

When the engagement scope explicitly calls for erm framework work in the enterprise risk management domain. Look for keywords like: risk, ERM, COSO, ISO 31000, risk appetite.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `risk-erm-framework-<client>-<YYYYMMDD>.md`.
