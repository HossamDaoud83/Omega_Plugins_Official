---
description: Assess BIM maturity (UK PAS 1192 / ISO 19650); produce BEP roadmap.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-construction:bim-readiness

**BIM Readiness.** Assess BIM maturity (UK PAS 1192 / ISO 19650); produce BEP roadmap.

## When to use

When the engagement scope explicitly calls for bim readiness work in the construction & epc domain. Look for keywords like: construction, EPC, FIDIC, NEC, BIM.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `construction-bim-readiness-<client>-<YYYYMMDD>.md`.
