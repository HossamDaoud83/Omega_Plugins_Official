---
description: Review FIDIC / NEC contract clauses for risk allocation gaps.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-construction:contract-review

**Contract Review.** Review FIDIC / NEC contract clauses for risk allocation gaps.

## When to use

When the engagement scope explicitly calls for contract review work in the construction & epc domain. Look for keywords like: construction, EPC, FIDIC, NEC, BIM.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `construction-contract-review-<client>-<YYYYMMDD>.md`.
