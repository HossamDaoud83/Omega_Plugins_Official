---
description: Set up cost + schedule controls (EVM, S-curves, drift analysis).
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-construction:project-controls

**Project Controls.** Set up cost + schedule controls (EVM, S-curves, drift analysis).

## When to use

When the engagement scope explicitly calls for project controls work in the construction & epc domain. Look for keywords like: construction, EPC, FIDIC, NEC, BIM.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `construction-project-controls-<client>-<YYYYMMDD>.md`.
