---
description: Analyze EOT/disruption claims using delay analysis methodologies (TIA, AACE 29R-03).
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-construction:claims-defense

**Claims Defense.** Analyze EOT/disruption claims using delay analysis methodologies (TIA, AACE 29R-03).

## When to use

When the engagement scope explicitly calls for claims defense work in the construction & epc domain. Look for keywords like: construction, EPC, FIDIC, NEC, BIM.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `construction-claims-defense-<client>-<YYYYMMDD>.md`.
