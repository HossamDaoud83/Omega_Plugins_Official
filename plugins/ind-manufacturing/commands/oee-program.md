---
description: Design OEE measurement + improvement program; benchmark against world-class (85%+).
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-manufacturing:oee-program

**OEE Program.** Design OEE measurement + improvement program; benchmark against world-class (85%+).

## When to use

When the engagement is in Manufacturing Industry and scope explicitly calls for oee program work. Look for keywords: manufacturing, MES, OEE, predictive maintenance, Industry 4.0.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `manufacturing-oee-program-<client>-<YYYYMMDD>.md`.
