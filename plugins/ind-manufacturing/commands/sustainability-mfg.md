---
description: Assess Scope 1+2 emissions, energy intensity, water use; design decarbonization roadmap.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-manufacturing:sustainability-mfg

**Sustainable Manufacturing.** Assess Scope 1+2 emissions, energy intensity, water use; design decarbonization roadmap.

## When to use

When the engagement is in Manufacturing Industry and scope explicitly calls for sustainable manufacturing work. Look for keywords: manufacturing, MES, OEE, predictive maintenance, Industry 4.0.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `manufacturing-sustainability-mfg-<client>-<YYYYMMDD>.md`.
