---
description: Map current PHI handling against HIPAA Privacy + Security Rule; identify gaps and remediation plan.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-healthcare:hipaa-gap

**HIPAA Gap.** Map current PHI handling against HIPAA Privacy + Security Rule; identify gaps and remediation plan.

## When to use

When the engagement is in Healthcare Industry and scope explicitly calls for hipaa gap work. Look for keywords: healthcare, HIS, EMR, HIPAA, HL7.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `healthcare-hipaa-gap-<client>-<YYYYMMDD>.md`.
