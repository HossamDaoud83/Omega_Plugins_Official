---
description: Evaluate master-data domains, golden record approach, and stewardship.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-data:mdm-assess

**MDM Assessment.** Evaluate master-data domains, golden record approach, and stewardship.

## When to use

When the engagement scope explicitly calls for mdm assessment work in the data strategy & architecture domain. Look for keywords like: data strategy, data architecture, data governance, MDM, lineage.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `data-mdm-assess-<client>-<YYYYMMDD>.md`.
