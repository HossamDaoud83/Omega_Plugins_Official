---
description: Articulate vision, value drivers, and 12-24 month data roadmap.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-data:data-strategy

**Data Strategy.** Articulate vision, value drivers, and 12-24 month data roadmap.

## When to use

When the engagement scope explicitly calls for data strategy work in the data strategy & architecture domain. Look for keywords like: data strategy, data architecture, data governance, MDM, lineage.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `data-data-strategy-<client>-<YYYYMMDD>.md`.
