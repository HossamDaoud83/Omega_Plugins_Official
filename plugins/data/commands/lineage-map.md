---
description: Produce end-to-end lineage from source systems through reporting.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-data:lineage-map

**Lineage Mapping.** Produce end-to-end lineage from source systems through reporting.

## When to use

When the engagement scope explicitly calls for lineage mapping work in the data strategy & architecture domain. Look for keywords like: data strategy, data architecture, data governance, MDM, lineage.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `data-lineage-map-<client>-<YYYYMMDD>.md`.
