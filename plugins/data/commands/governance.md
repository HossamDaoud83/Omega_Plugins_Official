---
description: Stand up a data governance operating model: roles, councils, decision rights.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-data:governance

**Governance Setup.** Stand up a data governance operating model: roles, councils, decision rights.

## When to use

When the engagement scope explicitly calls for governance setup work in the data strategy & architecture domain. Look for keywords like: data strategy, data architecture, data governance, MDM, lineage.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `data-governance-<client>-<YYYYMMDD>.md`.
