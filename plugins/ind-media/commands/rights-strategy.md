---
description: Strategize rights acquisition / licensing across windows and territories.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-media:rights-strategy

**Rights Strategy.** Strategize rights acquisition / licensing across windows and territories.

## When to use

When the engagement scope explicitly calls for rights strategy work in the media & entertainment domain. Look for keywords like: media, streaming, content, rights, AVOD.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `media-rights-strategy-<client>-<YYYYMMDD>.md`.
