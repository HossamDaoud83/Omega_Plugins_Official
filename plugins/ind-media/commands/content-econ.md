---
description: Model content economics: cost per hour, viewing share, unit economics.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-media:content-econ

**Content Economics.** Model content economics: cost per hour, viewing share, unit economics.

## When to use

When the engagement scope explicitly calls for content economics work in the media & entertainment domain. Look for keywords like: media, streaming, content, rights, AVOD.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `media-content-econ-<client>-<YYYYMMDD>.md`.
