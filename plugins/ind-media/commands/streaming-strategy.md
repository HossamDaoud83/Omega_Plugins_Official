---
description: Design streaming strategy: D2C, content mix, monetization model.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-media:streaming-strategy

**Streaming Strategy.** Design streaming strategy: D2C, content mix, monetization model.

## When to use

When the engagement scope explicitly calls for streaming strategy work in the media & entertainment domain. Look for keywords like: media, streaming, content, rights, AVOD.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `media-streaming-strategy-<client>-<YYYYMMDD>.md`.
