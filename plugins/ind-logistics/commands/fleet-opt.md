---
description: Optimize fleet size, mix, and routing for cost and service.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-logistics:fleet-opt

**Fleet Optimization.** Optimize fleet size, mix, and routing for cost and service.

## When to use

When the engagement scope explicitly calls for fleet optimization work in the logistics & 3pl domain. Look for keywords like: logistics, 3PL, fleet, warehouse, last-mile.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `logistics-fleet-opt-<client>-<YYYYMMDD>.md`.
