---
description: Review port/terminal operations for throughput, dwell time, asset utilization.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-logistics:port-ops

**Port Operations Review.** Review port/terminal operations for throughput, dwell time, asset utilization.

## When to use

When the engagement scope explicitly calls for port operations review work in the logistics & 3pl domain. Look for keywords like: logistics, 3PL, fleet, warehouse, last-mile.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `logistics-port-ops-<client>-<YYYYMMDD>.md`.
