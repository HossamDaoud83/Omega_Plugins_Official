---
description: Design warehouse layout, slotting, automation level.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-logistics:warehouse-design

**Warehouse Design.** Design warehouse layout, slotting, automation level.

## When to use

When the engagement scope explicitly calls for warehouse design work in the logistics & 3pl domain. Look for keywords like: logistics, 3PL, fleet, warehouse, last-mile.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `logistics-warehouse-design-<client>-<YYYYMMDD>.md`.
