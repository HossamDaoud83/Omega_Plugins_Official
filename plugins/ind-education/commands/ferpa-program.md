---
description: Map student-data handling against FERPA; identify gaps and remediation.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-education:ferpa-program

**FERPA Compliance Program.** Map student-data handling against FERPA; identify gaps and remediation.

## When to use

When the engagement is in Education Industry and scope explicitly calls for ferpa compliance program work. Look for keywords: education, K-12, higher ed, accreditation, LMS.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `education-ferpa-program-<client>-<YYYYMMDD>.md`.
