---
description: Evaluate LMS fit, faculty adoption, integration with SIS; recommend roadmap.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-education:lms-strategy

**LMS Strategy.** Evaluate LMS fit, faculty adoption, integration with SIS; recommend roadmap.

## When to use

When the engagement is in Education Industry and scope explicitly calls for lms strategy work. Look for keywords: education, K-12, higher ed, accreditation, LMS.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `education-lms-strategy-<client>-<YYYYMMDD>.md`.
