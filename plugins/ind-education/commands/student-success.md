---
description: Design retention + completion program: early-warning, advising redesign, intervention pathways.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-education:student-success

**Student Success Program.** Design retention + completion program: early-warning, advising redesign, intervention pathways.

## When to use

When the engagement is in Education Industry and scope explicitly calls for student success program work. Look for keywords: education, K-12, higher ed, accreditation, LMS.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `education-student-success-<client>-<YYYYMMDD>.md`.
