---
description: Propose new AR/EN term pairs from a draft document.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-aitranslate:glossary-extend

**Extend Glossary.** Propose new AR/EN term pairs from a draft document.

## When to use

When the engagement scope explicitly calls for extend glossary work in the ai bilingual translation domain. Look for keywords like: translate, translation, bilingual, Arabic, EN.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `aitranslate-glossary-extend-<client>-<YYYYMMDD>.md`.
