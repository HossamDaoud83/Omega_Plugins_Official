---
description: Optimize supply network footprint (DCs, plants, suppliers) for cost-to-serve.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-supply:network-design

**Network Design.** Optimize supply network footprint (DCs, plants, suppliers) for cost-to-serve.

## When to use

When the engagement scope explicitly calls for network design work in the supply chain & procurement domain. Look for keywords like: supply chain, sourcing, procurement, S&OP, IBP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `supply-network-design-<client>-<YYYYMMDD>.md`.
