---
description: Stand up integrated S&OP / IBP process with monthly cadence.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-supply:sop

**S&OP Process Design.** Stand up integrated S&OP / IBP process with monthly cadence.

## When to use

When the engagement scope explicitly calls for s&op process design work in the supply chain & procurement domain. Look for keywords like: supply chain, sourcing, procurement, S&OP, IBP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `supply-sop-<client>-<YYYYMMDD>.md`.
