---
description: Develop category sourcing strategy using Kraljic matrix; supplier consolidation analysis.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-supply:sourcing-strategy

**Sourcing Strategy.** Develop category sourcing strategy using Kraljic matrix; supplier consolidation analysis.

## When to use

When the engagement scope explicitly calls for sourcing strategy work in the supply chain & procurement domain. Look for keywords like: supply chain, sourcing, procurement, S&OP, IBP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `supply-sourcing-strategy-<client>-<YYYYMMDD>.md`.
