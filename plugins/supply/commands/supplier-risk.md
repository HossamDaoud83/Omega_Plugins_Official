---
description: Map supplier concentration, geopolitical exposure, financial health.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-supply:supplier-risk

**Supplier Risk Map.** Map supplier concentration, geopolitical exposure, financial health.

## When to use

When the engagement scope explicitly calls for supplier risk map work in the supply chain & procurement domain. Look for keywords like: supply chain, sourcing, procurement, S&OP, IBP.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `supply-supplier-risk-<client>-<YYYYMMDD>.md`.
