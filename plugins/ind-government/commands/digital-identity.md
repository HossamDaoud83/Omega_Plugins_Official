---
description: Design national or sectoral digital identity scheme; map to eIDAS / NIST 800-63 LoA.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-government:digital-identity

**Digital Identity.** Design national or sectoral digital identity scheme; map to eIDAS / NIST 800-63 LoA.

## When to use

When the engagement is in Government & Public Sector and scope explicitly calls for digital identity work. Look for keywords: government, public sector, e-government, citizen experience, open data.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `government-digital-identity-<client>-<YYYYMMDD>.md`.
