---
description: Modernize public procurement: e-procurement, framework agreements, transparency.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-government:procurement-mod

**Procurement Modernization.** Modernize public procurement: e-procurement, framework agreements, transparency.

## When to use

When the engagement is in Government & Public Sector and scope explicitly calls for procurement modernization work. Look for keywords: government, public sector, e-government, citizen experience, open data.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `government-procurement-mod-<client>-<YYYYMMDD>.md`.
