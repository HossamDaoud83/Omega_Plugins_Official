---
description: Map citizen journey across government touchpoints; identify friction and digital-first redesign opportunities.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-government:citizen-experience

**Citizen Experience.** Map citizen journey across government touchpoints; identify friction and digital-first redesign opportunities.

## When to use

When the engagement is in Government & Public Sector and scope explicitly calls for citizen experience work. Look for keywords: government, public sector, e-government, citizen experience, open data.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `government-citizen-experience-<client>-<YYYYMMDD>.md`.
