---
description: Define talent strategy: attract, develop, retain across critical roles.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-people:talent-strategy

**Talent Strategy.** Define talent strategy: attract, develop, retain across critical roles.

## When to use

When the engagement scope explicitly calls for talent strategy work in the people & organization domain. Look for keywords like: org design, target operating model, TOM, change management, ADKAR.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `people-talent-strategy-<client>-<YYYYMMDD>.md`.
