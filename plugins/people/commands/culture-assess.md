---
description: Diagnose organizational culture using validated instrument; identify levers.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-people:culture-assess

**Culture Assessment.** Diagnose organizational culture using validated instrument; identify levers.

## When to use

When the engagement scope explicitly calls for culture assessment work in the people & organization domain. Look for keywords like: org design, target operating model, TOM, change management, ADKAR.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `people-culture-assess-<client>-<YYYYMMDD>.md`.
