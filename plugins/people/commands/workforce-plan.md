---
description: Build skill-based workforce plan with gap analysis and reskilling roadmap.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-people:workforce-plan

**Workforce Plan.** Build skill-based workforce plan with gap analysis and reskilling roadmap.

## When to use

When the engagement scope explicitly calls for workforce plan work in the people & organization domain. Look for keywords like: org design, target operating model, TOM, change management, ADKAR.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `people-workforce-plan-<client>-<YYYYMMDD>.md`.
