---
description: Design target operating model and organization structure.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-people:org-design

**Org Design.** Design target operating model and organization structure.

## When to use

When the engagement scope explicitly calls for org design work in the people & organization domain. Look for keywords like: org design, target operating model, TOM, change management, ADKAR.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `people-org-design-<client>-<YYYYMMDD>.md`.
