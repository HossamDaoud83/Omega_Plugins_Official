---
description: Frame a research question into PICO / SPIDER style sub-questions and search terms.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-airesearch:topic-scope

**Topic Scoping.** Frame a research question into PICO / SPIDER style sub-questions and search terms.

## When to use

When the engagement scope explicitly calls for topic scoping work in the ai-assisted research domain. Look for keywords like: research, secondary research, source triangulation, citation, evidence.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `airesearch-topic-scope-<client>-<YYYYMMDD>.md`.
