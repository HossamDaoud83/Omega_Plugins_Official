---
description: Synthesize findings into a structured brief with explicit confidence per claim.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-airesearch:synthesis

**Research Synthesis.** Synthesize findings into a structured brief with explicit confidence per claim.

## When to use

When the engagement scope explicitly calls for research synthesis work in the ai-assisted research domain. Look for keywords like: research, secondary research, source triangulation, citation, evidence.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `airesearch-synthesis-<client>-<YYYYMMDD>.md`.
