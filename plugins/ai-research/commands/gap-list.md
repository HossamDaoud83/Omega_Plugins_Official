---
description: Identify unresolved questions and recommended primary research.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-airesearch:gap-list

**Research Gap List.** Identify unresolved questions and recommended primary research.

## When to use

When the engagement scope explicitly calls for research gap list work in the ai-assisted research domain. Look for keywords like: research, secondary research, source triangulation, citation, evidence.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `airesearch-gap-list-<client>-<YYYYMMDD>.md`.
