---
description: Cross-check claims across ≥3 independent sources; flag single-source claims.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-airesearch:triangulate

**Triangulate Findings.** Cross-check claims across ≥3 independent sources; flag single-source claims.

## When to use

When the engagement scope explicitly calls for triangulate findings work in the ai-assisted research domain. Look for keywords like: research, secondary research, source triangulation, citation, evidence.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `airesearch-triangulate-<client>-<YYYYMMDD>.md`.
