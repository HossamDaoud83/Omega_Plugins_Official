---
description: Configure jurisdictions and source feeds (gazettes, regulator circulars, EU OJ).
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-airegs:jurisdiction-setup

**Jurisdiction Setup.** Configure jurisdictions and source feeds (gazettes, regulator circulars, EU OJ).

## When to use

When the engagement scope explicitly calls for jurisdiction setup work in the ai regulatory tracking domain. Look for keywords like: regulatory, gazette, circular, regulation, compliance.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `airegs-jurisdiction-setup-<client>-<YYYYMMDD>.md`.
