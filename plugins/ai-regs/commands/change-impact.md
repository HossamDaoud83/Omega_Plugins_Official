---
description: Analyze a regulatory change for client-impact (which controls, deliverables, processes affected).
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-airegs:change-impact

**Change Impact.** Analyze a regulatory change for client-impact (which controls, deliverables, processes affected).

## When to use

When the engagement scope explicitly calls for change impact work in the ai regulatory tracking domain. Look for keywords like: regulatory, gazette, circular, regulation, compliance.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `airegs-change-impact-<client>-<YYYYMMDD>.md`.
