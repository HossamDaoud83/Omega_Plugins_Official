---
description: Patient Journey (Omega HLT service line)
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-hlt:patient-journey
...
3. Execute the methodology for "Patient Journey" producing a Omega-branded deliverable.
