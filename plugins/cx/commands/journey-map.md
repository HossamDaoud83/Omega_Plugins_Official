---
description: Map current-state and future-state customer journeys with pain points and moments-of-truth.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-cx:journey-map

**Journey Mapping.** Map current-state and future-state customer journeys with pain points and moments-of-truth.

## When to use

When the engagement scope explicitly calls for journey mapping work in the customer experience domain. Look for keywords like: CX, customer experience, journey map, VoC, NPS.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `cx-journey-map-<client>-<YYYYMMDD>.md`.
