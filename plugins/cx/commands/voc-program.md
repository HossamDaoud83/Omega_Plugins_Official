---
description: Design voice-of-customer program: channels, cadence, governance, action loops.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-cx:voc-program

**VoC Program Setup.** Design voice-of-customer program: channels, cadence, governance, action loops.

## When to use

When the engagement scope explicitly calls for voc program setup work in the customer experience domain. Look for keywords like: CX, customer experience, journey map, VoC, NPS.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `cx-voc-program-<client>-<YYYYMMDD>.md`.
