---
description: Author service blueprint showing front-stage, back-stage, and supporting processes.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-cx:service-blueprint

**Service Blueprint.** Author service blueprint showing front-stage, back-stage, and supporting processes.

## When to use

When the engagement scope explicitly calls for service blueprint work in the customer experience domain. Look for keywords like: CX, customer experience, journey map, VoC, NPS.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `cx-service-blueprint-<client>-<YYYYMMDD>.md`.
