---
description: Strategize mission-critical communications (LMR, P25, MCPTT).
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-publicsafety:mcc-strategy

**Mission Critical Comms.** Strategize mission-critical communications (LMR, P25, MCPTT).

## When to use

When the engagement scope explicitly calls for mission critical comms work in the public safety domain. Look for keywords like: public safety, police, fire, EMS, emergency management.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `publicsafety-mcc-strategy-<client>-<YYYYMMDD>.md`.
