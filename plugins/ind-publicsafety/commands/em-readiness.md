---
description: Assess emergency-management readiness against ICS / NIMS / equivalent.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-publicsafety:em-readiness

**Emergency Mgmt Readiness.** Assess emergency-management readiness against ICS / NIMS / equivalent.

## When to use

When the engagement scope explicitly calls for emergency mgmt readiness work in the public safety domain. Look for keywords like: public safety, police, fire, EMS, emergency management.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `publicsafety-em-readiness-<client>-<YYYYMMDD>.md`.
