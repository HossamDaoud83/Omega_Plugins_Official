---
description: Review computer-aided dispatch and records management system maturity.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-publicsafety:cad-review

**CAD/RMS Review.** Review computer-aided dispatch and records management system maturity.

## When to use

When the engagement scope explicitly calls for cad/rms review work in the public safety domain. Look for keywords like: public safety, police, fire, EMS, emergency management.
...
5. Place the deliverable in `05_Deliverables_Final/` per the Omega file-location standard. Filename pattern: `publicsafety-cad-review-<client>-<YYYYMMDD>.md`.
