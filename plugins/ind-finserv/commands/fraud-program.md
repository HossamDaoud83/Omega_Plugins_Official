---
description: Assess fraud detection program (rules + ML), false-positive rates, customer impact.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-finserv:fraud-program

**Fraud Program.** Assess fraud detection program (rules + ML), false-positive rates, customer impact.

## When to use

When the engagement is in Financial Services Industry and scope explicitly calls for fraud program work. Look for keywords: banking, insurance, fintech, AML, KYC.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `finserv-fraud-program-<client>-<YYYYMMDD>.md`.
