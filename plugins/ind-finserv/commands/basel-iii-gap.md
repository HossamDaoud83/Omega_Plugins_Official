---
description: Map current capital, liquidity, and leverage ratios against Basel III requirements (CET1, LCR, NSFR).
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-finserv:basel-iii-gap

**Basel III Gap.** Map current capital, liquidity, and leverage ratios against Basel III requirements (CET1, LCR, NSFR).

## When to use

When the engagement is in Financial Services Industry and scope explicitly calls for basel iii gap work. Look for keywords: banking, insurance, fintech, AML, KYC.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `finserv-basel-iii-gap-<client>-<YYYYMMDD>.md`.
