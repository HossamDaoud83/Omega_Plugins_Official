---
description: Assess AML program maturity (transaction monitoring, sanctions screening, SAR filing) against FATF and local regulator expectations.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# /omega-ind-finserv:aml-readiness

**AML Readiness.** Assess AML program maturity (transaction monitoring, sanctions screening, SAR filing) against FATF and local regulator expectations.

## When to use

When the engagement is in Financial Services Industry and scope explicitly calls for aml readiness work. Look for keywords: banking, insurance, fintech, AML, KYC.
...
5. Place output in `05_Deliverables_Final/` per Omega file-location standard. Filename: `finserv-aml-readiness-<client>-<YYYYMMDD>.md`.
